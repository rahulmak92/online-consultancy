<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePostLogin.master" AutoEventWireup="true" CodeFile="BusinessRequestHistory.aspx.cs" Inherits="BusinessRequestHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <br />
&nbsp;
<a href="Accouting.aspx" style="font-size:small;color:#7a0c4a;text-decoration:none">Business Planning »</a>
<span style="font-size:small;text-decoration:none">Business Planning Request History</span>
<br />
&nbsp;----------------------------------------------------------------------------------------------------------------------
...
<span style="font-size:small;text-align:center">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [requestId], [name], [requestTitle], [requestType], [deadline], [requestStatus], [uploadFile], [resultFile] FROM [RqstBusiness] WHERE ([username] = @username)">
        <SelectParameters>
