<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePostLogin.master" AutoEventWireup="true" CodeFile="AccountingRequest.aspx.cs" Inherits="AccountingRequest" %>
...
<asp:Button ID="Button2" runat="server" Width="212" Height="50" CssClass="btn2" 
        Text="⊲ HISTORY" onclick="Button2_Click" />
...
<span style="font-size:small;text-decoration:none">Accouting Request</span>
<br />
&nbsp;----------------------------------------------------------------------------------------------------------------------
<br />
    <br />
...
<tr>
    <td>Accounting Request Title</td>
