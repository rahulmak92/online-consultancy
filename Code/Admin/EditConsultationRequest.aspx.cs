...
public partial class Admin_EditConsultationRequest : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditRequest")
        {
            ...
            Session["id"] = reqid;
            Response.Redirect("ExpandConsultationRequest.aspx");
        }
        ...
        if (e.CommandName == "DownloadResultFile")
        {
          ...
          //  Label1.Text = filename;
            ...
            string[] filepaths = Directory.GetFiles(Server.MapPath("~/ResultFiles/Consultation/"));
        ...
        if (e.CommandName == "DownloadClientFile")
        {
            ...
            string[] filepaths = Directory.GetFiles(Server.MapPath("~/Files/" + user + "/Consultation/"));
            foreach (string filepath in filepaths)
            {
                if (Path.GetFileName(filepath) == filename)
                {
