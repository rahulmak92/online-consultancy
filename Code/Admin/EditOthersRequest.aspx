<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="EditOthersRequest.aspx.cs" Inherits="Admin_EditOthersRequest" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <br />
<span style="font-size:x-large;margin-left:40px"><b>Other Request</b></span>
<br />
<br /><asp:Label ID="Label1" runat="server" Text=""></asp:Label>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="othersTitle" HeaderText="Title" 
                SortExpression="othersTitle" />
            <asp:BoundField DataField="othersType" HeaderText="Type" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [requestId], [username], [name], [othersTitle], [othersType], [deadline], [uploadFile], [resultFile], [requestStatus] FROM [RqstOthers]"
        DeleteCommand="DELETE FROM RqstOthers WHERE requestId=@requestId">
        <DeleteParameters>
