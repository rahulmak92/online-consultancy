<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="EditAccountingRequest.aspx.cs" Inherits="Admin_EditAccountingRequest" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br />
<span style="font-size:x-large;margin-left:40px"><b>Accounting Request</b></span>
<br />
<br /><asp:Label ID="Label1" runat="server" Text=""></asp:Label>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [requestId], [username], [name], [requestTitle], [requestType], [deadline], [uploadFile], [resultFile], [requestStatus] FROM [RqstAccouting]"
        DeleteCommand="DELETE FROM RqstAccouting WHERE requestId=@requestId">
        <DeleteParameters>
