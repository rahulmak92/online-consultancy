...
public partial class Admin_EditOthersRequest : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditRequest")
        {
            ...
            Session["id"] = reqid;
            Response.Redirect("ExpandOthersRequest.aspx");
        }
        ...
        if (e.CommandName == "DownloadResultFile")
        {
            ...
            string[] filepaths = Directory.GetFiles(Server.MapPath("~/ResultFiles/Others/"));
        ...
        if (e.CommandName == "DownloadClientFile")
        {
            ...
            string[] filepaths = Directory.GetFiles(Server.MapPath("~/Files/" + user + "/Others/"));
            foreach (string filepath in filepaths)
            {
                if (Path.GetFileName(filepath) == filename)
                {
