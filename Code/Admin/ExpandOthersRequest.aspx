<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="ExpandOthersRequest.aspx.cs" Inherits="Admin_ExpandOthersRequest" %>
...
<table style="margin-left:150px">
    ...
    <tr>
        <td>Type</td>
        <td>
            <asp:TextBox ID="TextBox7" runat="server" Width="290px" Enabled="false"></asp:TextBox>
        </td>
    </tr>
    <tr><td></td></tr>
    <tr><td></td></tr>
