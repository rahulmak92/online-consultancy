<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="EditConsultationRequest.aspx.cs" Inherits="Admin_EditConsultationRequest" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <br />
<span style="font-size:x-large;margin-left:40px"><b>Consultation Request</b></span>
<br /><br /><asp:Label ID="Label1" runat="server" Text=""></asp:Label>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="consultationTitle" HeaderText="Title" 
                SortExpression="requestTitle" />
            <asp:BoundField DataField="consultationType" HeaderText="Type" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [requestId], [username], [name], [consultationTitle], [consultationType], [deadline], [uploadFile], [resultFile], [requestStatus] FROM [RqstConsultation]"
        DeleteCommand="DELETE FROM RqstConsultation WHERE requestId=@requestId">
        <DeleteParameters>
