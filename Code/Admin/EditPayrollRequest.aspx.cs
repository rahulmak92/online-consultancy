...
public partial class Admin_EditPayrollRequest : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "EditRequest")
        {
            ...
            Session["id"] = reqid;
            Response.Redirect("ExpandPayrollRequest.aspx");
        }
        ...
        if (e.CommandName == "DownloadResultFile")
        {
            ...
            string[] filepaths = Directory.GetFiles(Server.MapPath("~/ResultFiles/Payroll/"));
        ...
        if (e.CommandName == "DownloadClientFile")
        {
            ...
            string[] filepaths = Directory.GetFiles(Server.MapPath("~/Files/" + user + "/Payroll/"));
            foreach (string filepath in filepaths)
            {
                if (Path.GetFileName(filepath) == filename)
                {
