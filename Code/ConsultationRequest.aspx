<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePostLogin.master" AutoEventWireup="true" CodeFile="ConsultationRequest.aspx.cs" Inherits="ConsultationRequest" %>
...
<span style="font-size:small;text-decoration:none">Consultation Request</span>
<br />
&nbsp;----------------------------------------------------------------------------------------------------------------------
<br />
    <br />
...
&nbsp&nbsp&nbsp&nbsp;<span style="color:#5C062D;font-size:x-large">Add Request<span style="font-size:small"><span style="margin-left:100px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<td><asp:FileUpload ID="FileUpload1" runat="server" Width="292px" />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
        ErrorMessage="You must select a file" ControlToValidate="FileUpload1" ForeColor="Red"></asp:RequiredFieldValidator>
    <br /><br /></td>
</tr> 
</table>   
