<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePostLogin.master" AutoEventWireup="true" CodeFile="OthersRequest.aspx.cs" Inherits="OthersRequest" %>
...
<span style="font-size:small;text-decoration:none">Request</span>
<br />
&nbsp;----------------------------------------------------------------------------------------------------------------------
<br />
    <br />
...
&nbsp&nbsp&nbsp&nbsp;<span style="color:#5C062D;font-size:x-large">Add Request</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:small"><span style="margin-left:100px"><asp:Label ID="lblFileUpload" runat="server" Text="" ForeColor="Red"></asp:Label>
...
<tr>
    ...
    <td>
<span style="font-size:small">
        <asp:TextBox ID="txtType" runat="server" style="margin-left: 1px" 
            Width="290px" Height="22px"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
            ErrorMessage="Mention Type of Request" ForeColor="Red" ControlToValidate="txtType"></asp:RequiredFieldValidator>
</span>
        <br />
        <br /></td>
</tr>    
