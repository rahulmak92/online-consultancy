<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPagePostLogin.master" AutoEventWireup="true" CodeFile="PayrollRequestHistory.aspx.cs" Inherits="PayrollRequestHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <br />
&nbsp;
<a href="Payroll.aspx" style="font-size:small;color:#7a0c4a;text-decoration:none">Payroll »</a>
<span style="font-size:small;text-decoration:none">Payroll Request History</span>
<br />
&nbsp;----------------------------------------------------------------------------------------------------------------------
...
<span style="font-size:small;text-align:center">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        ForeColor="Black" 
        OnRowCommand="GridView1_RowCommand" AllowPaging="True" CssClass="gridview">
        <Columns>
            <asp:BoundField DataField="requestId" HeaderText="Req ID" SortExpression="requestId" />
            <asp:BoundField DataField="name" HeaderText="Name" SortExpression="name" />
            <asp:BoundField DataField="payrollTitle" HeaderText="Request Title" 
                SortExpression="payrollTitle" />
            <asp:BoundField DataField="payrollType" HeaderText="Request Type" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [requestId], [name], [email], [payrollTitle], [payrollType], [deadline], [requestStatus], [uploadFile], [resultFile] FROM [RqstPayroll] WHERE ([username] = @username)">
        <SelectParameters>
